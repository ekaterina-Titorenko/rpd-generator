...
@section('content')
    <section class="card">
        ...
        @php
            $prefillName = old('name', $defaultAuthor?->name);
            $prefillPosition = old('position', $defaultAuthor?->position);
            $prefillOrganization = old('organization', $defaultAuthor?->organization);
        @endphp

        @if ($defaultAuthor)
            <div class="card-body">
                <div class="alert alert-warning">
                    Подставлены данные из последней РПД. При необходимости отредактируйте их перед добавлением.
                </div>
            </div>
        @endif
