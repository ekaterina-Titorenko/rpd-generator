                ...
                <div class="review-actions">
                    <div class="form-field form-field-wide">
                        ...
                        <textarea
                            ...
                            rows="4"
                            form="approve-form"
                            placeholder="Например: уточнить календарный график, исправить распределение часов, добавить литературу."
                        >{{ old('review_comment', $rpdProgram->review_comment) }}</textarea>
                    </div>
