...
<section class="card">
        ...
        <div class="actions">
            ...
            <form method="POST" action="{{ route('rpd-programs.schedule.generate', $rpdProgram) }}">
                ...
                <button
                    ...
                    title="Перезаписать текущий календарный график и заново распределить часы по учебному плану. Количество недель вернётся к рекомендуемому значению."
    ...
    <div class="card-body">
        <div class="schedule-help">
            ...
            заполняйте ячейки в формате <span>Т (2)</span> или <span>П (2)</span>.
            Если в неделе есть и теория, и практика — укажите их с новой строки.
        </div>
