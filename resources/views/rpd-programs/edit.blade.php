    ...
    <div class="card-body form-grid">
        ...
        <div class="form-field">
            ...
            <select id="complexity_level" name="complexity_level" required>
                <option value="базовый" @selected(old('complexity_level', $rpdProgram->complexity_level) === 'базовый')>Базовый</option>
                <option value="продвинутый" @selected(old('complexity_level', $rpdProgram->complexity_level) === 'продвинутый')>Продвинутый</option>
            </select>
        </div>
